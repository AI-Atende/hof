  ...
  const steps = [
    {
      ...
      description: "Começamos com uma consulta detalhada para entender suas expectativas e analisar suas características faciais únicas.",
      highlight: "Consulta individual de 45 minutos"
    },
    {
      icon: PenTool,
      title: "Planejamento Individualizado",
      description: "Nossa equipe cria um plano de tratamento sob medida, utilizando as técnicas mais avançadas para resultados naturais.",
      highlight: "Plano personalizado e exclusivo"
    },
    {
      icon: Heart,
      title: "Procedimento Confortável",
      description: "Realizamos os procedimentos com o máximo de conforto e segurança, em um ambiente acolhedor e com equipamentos de ponta.",
      highlight: "Ambiente relaxante e seguro"
    },
    {
      icon: Shield,
      title: "Acompanhamento Pós-Procedimento",
      description: "Oferecemos suporte contínuo e acompanhamento para garantir sua satisfação e otimizar os resultados.",
          ...
          <div className="animate-slide-up">
            ...
            <div className="space-y-6">
              {steps.map((step, index) => (
                <div key={index} className="flex gap-4 p-4 rounded-xl hover:bg-rose-50 transition-colors group">
            ...
            <div className="bg-gradient-to-br from-rose-50 to-gold-50 rounded-3xl p-8">
              ...
              <div className="relative aspect-video bg-gradient-to-br from-rose-200 to-rose-300 rounded-2xl flex items-center justify-center group cursor-pointer hover:from-rose-300 hover:to-rose-400 transition-all">
                <div className="text-center">
                  ...
                  <p className="text-rose-700 font-medium">Clique para assistir</p>
                  <p className="text-rose-600 text-sm mt-1">Duração: 2 minutos</p>
                </div>
              </div>
              ...
              <div className="mt-6 space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700">O que é a Harmonização Orofacial</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500" />
                  <span className="text-gray-700">Benefícios e segurança do procedimento</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500" />
                  <span className="text-gray-700">O que esperar dos resultados</span>
                </div>
              </div>
            </div>
          </div>
