  ...
  const diferenciais = [
    {
      ...
      description: "Equipe altamente qualificada e em constante atualização nas mais avançadas técnicas de harmonização orofacial.",
      highlight: "Certificações internacionais"
    },
    {
      icon: Zap,
      title: "Tecnologia de Ponta",
      description: "Utilizamos equipamentos de última geração e produtos de alta qualidade, garantindo segurança e resultados superiores.",
      highlight: "Equipamentos importados"
    },
    {
      icon: Heart,
      title: "Atendimento Humanizado",
      description: "Cuidado personalizado e atenção a cada detalhe, desde a primeira consulta até o pós-procedimento.",
      highlight: "Suporte 24/7"
    },
    {
      icon: Award,
      title: "Resultados Naturais e Duradouros",
      description: "Nosso foco é realçar sua beleza de forma sutil e elegante, com harmonia e longevidade.",
    ...
    <section id="diferenciais" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center">
          <div className="bg-gradient-to-br from-gold-50 to-rose-50 rounded-3xl p-8 inline-block">
            <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
              Pronto para Sua Transformação?
            </h3>
            <p className="text-lg text-gray-600 mb-6">
              Junte-se a mais de 1000 pessoas que já transformaram suas vidas
            </p>
            <button 
              onClick={() => scrollToSection('contato')}
              className="bg-gradient-to-r from-rose-500 to-rose-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:from-rose-600 hover:to-rose-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 inline-flex items-center gap-2"
            >
              Agende Sua Consulta e Sinta a Diferença!
